...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($cartnav->updateCartNav($id, $title, $image, $description) == true){
        header("Location:?act=cartNav");
    }else{
        echo "Error: nhaaaaa ";
    }
}
...
<body>
    <div class="container my-5">
        <form action="?act=processingCartNav" method="post" class="needs-validation" novalidate>
        <div class="mb-3">
